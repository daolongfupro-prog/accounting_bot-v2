...
TEXTS: dict[str, dict[str, str]] = {
    "ru": {
        ...
        "greeting_massage": "🌟 Здравствуйте, <b>{name}</b>!\nРады приветствовать вас в боте учета сеансов.\n\nВыберите язык / Tilni tanlang / Choose language:",
        "greeting_edu": "🌟 Здравствуйте, <b>{name}</b>!\nРады приветствовать вас в боте учета занятий.\n\nВыберите язык / Tilni tanlang / Choose language:",
        "no_history": "У вас пока нет истории посещений.",
        "history_head": "📈 <b>Ваша история посещений:</b>\n\n",
    },
    "uz": {
        "main_menu": "Harakatni tanlang:",
        "balance": "📊 Mening qoldig'im",
        "my_stats": "📈 Mening tarixim",
        ...
        "choose_lang": "Выберите язык / Tilni tanlang / Choose language:",
        "greeting_massage": "🌟 Xush kelibsiz, <b>{name}</b>!\nSeanslarni hisobga olish botiga xush kelibsiz.\n\nВыберите язык / Tilni tanlang / Choose language:",
        "greeting_edu": "🌟 Xush kelibsiz, <b>{name}</b>!\nMashg'ulotlarni hisobga olish botiga xush kelibsiz.\n\nВыберите язык / Tilni tanlang / Choose language:",
        "no_history": "Sizda hozircha tashriflar tarixi yo'q.",
        "history_head": "📈 <b>Sizning tashriflar tarixingiz:</b>\n\n",
    },
    "en": {
        ...
        "choose_lang": "Выберите язык / Tilni tanlang / Choose language:",
        "greeting_massage": "🌟 Hello, <b>{name}</b>!\nWelcome to the session tracking bot.\n\nВыберите язык / Tilni tanlang / Choose language:",
        "greeting_edu": "🌟 Hello, <b>{name}</b>!\nWelcome to the class tracking bot.\n\nВыберите язык / Tilni tanlang / Choose language:",
        "no_history": "You have no visit history yet.",
        "history_head": "📈 <b>Your visit history:</b>\n\n",
    },
}
